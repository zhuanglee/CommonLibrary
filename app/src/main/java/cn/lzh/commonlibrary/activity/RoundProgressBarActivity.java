...
public class RoundProgressBarActivity extends Activity {
	private RingProgressBar mRoundProgressBar1, mRoundProgressBar2 ,mRoundProgressBar3, mRoundProgressBar4, mRoundProgressBar5;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mRoundProgressBar3 = (RingProgressBar) findViewById(R.id.roundProgressBar3);
		mRoundProgressBar4 = (RingProgressBar) findViewById(R.id.roundProgressBar4);
		mRoundProgressBar5 = (RingProgressBar) findViewById(R.id.roundProgressBar5);
