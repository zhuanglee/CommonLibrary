...
public class CalendarActivity extends BaseWatermarkActivity implements OnClickListener, CalendarCard.OnClickCellListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {  
        ...
        mCanlendarCard.setSelectedDate(new CalendarUtil.CustomDate());
    ...
    @Override  
    public void onClickDate(CalendarUtil.CustomDate date, CalendarCard.SildeDirection state) {
          ToastUtils.show(getApplication(), date.toString());
    }
  
    @Override  
    public void onChangeCalendar(CalendarUtil.CustomDate date) {
