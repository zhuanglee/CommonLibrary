...
public class BytesTransUtil {
	...
	public static short[] getBytes2Shorts(byte[] buf) {
		byte bLength = 2;
	...
	public static byte[] getShorts2Bytes(short[] s) {
		byte bLength = 2;
	...
	public static int[] getBytes2Ints(byte[] buf) {
		byte bLength = 4;
	...
	public static byte[] getInts2Bytes(int[] s) {
		byte bLength = 4;
		byte[] buf = new byte[s.length * bLength];
		for (int iLoop = 0; iLoop < s.length; iLoop++) {
			byte[] temp = getBytes(s[iLoop]);
	...
	public static long[] getBytes2Longs(byte[] buf) {
		byte bLength = 8;
	...
	public static byte[] getLongs2Bytes(long[] s) {
		byte bLength = 8;
		byte[] buf = new byte[s.length * bLength];
		for (int iLoop = 0; iLoop < s.length; iLoop++) {
			byte[] temp = getBytes(s[iLoop]);
