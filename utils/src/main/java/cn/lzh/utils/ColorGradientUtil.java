...
public class ColorGradientUtil {
     ...
     */
    public static int getColor(int startColor, int endColor, float rate){
        String strStartColor = "#" + Integer.toHexString(startColor);
        String strEndColor = "#" + Integer.toHexString(endColor);
        return Color.parseColor(getColor(strStartColor, strEndColor, rate));
    }
     ...
     */
    public static String getColor(String startColor, String endColor, float rate){
        ...
        int currentAlpha = (int) ((endAlpha - startAlpha) * rate + startAlpha);
        int currentRed = (int) ((endRed - startRed) * rate + startRed);
        int currentGreen = (int) ((endGreen - startGreen) * rate + startGreen);
        int currentBlue = (int) ((endBlue - startBlue) * rate + startBlue);
