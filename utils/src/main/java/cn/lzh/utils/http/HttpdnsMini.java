...
public class HttpdnsMini {
        ...
        public String call() {
            ...
            try {
                ...
                if (conn.getResponseCode() != 200) {
                    Log.e(TAG, "responseCodeNot 200, but: " + conn.getResponseCode());
                } else {
                    ...
                    if (host != null) {
                        ...
                        Log.d(TAG, "resolve host:" + host + " ip:" + ip + " ttl:" + ttl);
    ...
    public String getIpByHost(String hostName) {
        ...
        if (host == null || host.isExpired()) {
            Log.d(TAG, "refresh host: " + hostName);
