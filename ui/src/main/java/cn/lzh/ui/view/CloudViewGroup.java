...
public class CloudViewGroup extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		setMeasuredDimension((modeWidth == MeasureSpec.EXACTLY) ? sizeWidth + mViewMargin
				: width + mViewMargin, (modeHeight == MeasureSpec.EXACTLY) ? sizeHeight + mViewMargin
				: height + mViewMargin);
...
//			Log.e(TAG, "第" + i + "行， ：" + lineHeight);
	...
	public void addView(View child) {
		...
		lp.setMargins(mViewMargin, mViewMargin, 0,0);
